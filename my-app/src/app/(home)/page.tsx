...
import { ChevronRight, ClipboardList, FolderClosed } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <Container className="space-y-6">
      ...
      <Card className="w-full rounded-[.5rem]">
        ...
        <CardContent>
          <Text isDifferent={true}>
            Olá, meu nome é Henry, tenho 18 anos e sou desenvolvedor front-end.
      ...
      <Card className="w-full rounded-[.5rem] space-y-5">
        <div>
          <CardHeader className="flex flex-row justify-between">
            <CardTitle className="flex gap-2">
